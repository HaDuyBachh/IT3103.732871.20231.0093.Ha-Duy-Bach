...
//import hust.soict.dsai.aims.screen.DetailScreen;
//import hust.soict.dsai.aims.screen.PlaceOrderScreen;
...
public class CartScreenController {
	...
	private void initialize() {
		...
		tblMedia.setItems(cart.getItemsOrder());
	...
	void showFilteredMedia(String input) {
		...
		FilteredList<Media> filteredList = new FilteredList<>(cart.getItemsOrder());
